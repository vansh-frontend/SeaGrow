...
import { Heart, Share2, Trash2, Edit2, MessageCircle } from 'lucide-react';
...
const Community = () => {
  ...
  const [comments, setComments] = useState<any>({}); // Track comments per post
  const [editingPost, setEditingPost] = useState<any | null>(null);
  const [showShareModal, setShowShareModal] = useState<string>('');
